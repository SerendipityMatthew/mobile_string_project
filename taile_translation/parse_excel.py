...
def generate_module_string_to_xml(module_name, module_string_list, xml_file_name="strings.xml"):
    ...
    if len(string_dict) != 0:
        ...
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-zh-rCN",
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-en-rUS",
                            file_name=xml_file_name)
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-ko-rKR",
                            file_name=xml_file_name)
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-ja-rJP",
                            file_name=xml_file_name)
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-de-rDE",
                            file_name=xml_file_name)
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(trimmed_string_dict,
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-ru-rRU",
                            file_name=xml_file_name)
    string_dict.clear()
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values-es-rES",
                            file_name=xml_file_name)
    string_dict.clear()
    ...
    if len(string_dict) != 0:
        ...
        for stringA in string_dict.keys():
            ...
            print("--------------- string_dict[stringA] ", )
        if len(trimmed_string_dict) != 0:
            generate_string_res(string_dict, module_name_path + "/src/main/res/" + "values", file_name=xml_file_name)
...
if __name__ == "__main__":
    ...
    for android_string in android_string_list:
        module_name_list.append(android_string.module_name)

    print("=============== android_string_list.size = ", len(android_string_list))
    module_list = list(set(module_name_list))
    for module_name in module_list:
        generate_module_string_to_xml(module_name, android_string_list, )
